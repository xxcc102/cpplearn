...
bool CSerialPort::InitPort(UINT portNo /*= 1*/, UINT baud /*= CBR_9600*/, char parity /*= 'N'*/,UINT databits /*= 8*/, UINT stopsbits /*= 1*/, 
...
bool CSerialPort::openPort(UINT portNo)
{
	...
	m_hComm = CreateFileA( szPort,  /** 设备名,COM1,COM2等 */
												GENERIC_WRITE| GENERIC_READ, /** 访问模式,读 */
												0,                             /** 共享模式,0表示不共享 */
												NULL,                         /** 安全性设置,一般使用NULL */

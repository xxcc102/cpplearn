...
void slist_free(SListEntry *list)
{
	...
	while (entry != NULL) {
		if (entry->pmatrixidata != NULL)
		{
			free(entry->pmatrixidata);
		}
...
SListEntry *slist_prepend(SListEntry **list, SListEntry *data)
{
	SListEntry *newentry;
	...
	memcpy(newentry, data, sizeof(SListEntry));
	//newentry->index = data;
...
SListEntry *slist_append(SListEntry **list, SListEntry *data)
{
	SListEntry *rover;
	SListEntry *newentry;
